...
-- 1. Admin
INSERT INTO user (name, role, email, password, department_id)
...
VALUES (
    (SELECT id FROM user WHERE name = '김마을장'),
...
INSERT INTO user (name, birth_date, role, email, password, department_id)
VALUES 
...
VALUES (
    ...
    (SELECT id FROM user WHERE name = '이리더'),
    '2025-01-01'
);
...
VALUES 
    ((SELECT id FROM gbs_group WHERE name = '믿음 GBS'), (SELECT id FROM user WHERE name = '조원1'), '2025-01-01'),
    ((SELECT id FROM gbs_group WHERE name = '믿음 GBS'), (SELECT id FROM user WHERE name = '조원2'), '2025-01-01'),
    ((SELECT id FROM gbs_group WHERE name = '믿음 GBS'), (SELECT id FROM user WHERE name = '조원3'), '2025-01-01'); 