...
enum class ErrorMessage(
    ...
    FORBIDDEN(HttpStatus.BAD_REQUEST, "E403", "접근 권한이 없습니다"),
    RESOURCE_NOT_FOUND(HttpStatus.BAD_REQUEST, "E404", "요청한 리소스를 찾을 수 없습니다"),
    ...
    ACCESS_DENIED_GBS(HttpStatus.BAD_REQUEST, "E1010", "이 GBS의 멤버 정보를 조회할 권한이 없습니다"),
    ACCESS_DENIED_LEADER_HISTORY(HttpStatus.BAD_REQUEST, "E1011", "다른 리더의 히스토리를 조회할 권한이 없습니다"),
    ACCESS_DENIED_ATTENDANCE(HttpStatus.BAD_REQUEST, "E1012", "이 GBS에 대한 출석 입력 권한이 없습니다"),
    
    // GBS 관련 (E2000-E2099)
    GBS_GROUP_NOT_FOUND(HttpStatus.BAD_REQUEST, "E2000", "GBS 그룹을 찾을 수 없습니다"),
    NO_CURRENT_GBS_FOR_LEADER(HttpStatus.BAD_REQUEST, "E2001", "현재 담당하는 GBS가 없습니다"),
    ...
    DELEGATEE_NOT_FOUND(HttpStatus.BAD_REQUEST, "E3001", "수임자를 찾을 수 없습니다"),
    ...
    // 출석 관련 (E4000-E4099)
    WORSHIP_NOT_FOUND(HttpStatus.BAD_REQUEST, "E4000", "예배 정보를 찾을 수 없습니다"),
    ATTENDANCE_NOT_FOUND(HttpStatus.BAD_REQUEST, "E4001", "출석 정보를 찾을 수 없습니다"),
    GBS_WEEK_NOT_FOUND(HttpStatus.BAD_REQUEST, "E4002", "해당 주차의 GBS 정보를 찾을 수 없습니다"),
    INVALID_WEEK_START(HttpStatus.BAD_REQUEST, "E4003", "주 시작일은 일요일이어야 합니다"),
    
    // 사용자/멤버 관련 (E5000-E5099)
    USER_NOT_FOUND(HttpStatus.BAD_REQUEST, "E5000", "사용자를 찾을 수 없습니다"),
    LEADER_NOT_FOUND(HttpStatus.BAD_REQUEST, "E5001", "해당 리더를 찾을 수 없습니다"),
    MEMBER_NOT_FOUND(HttpStatus.BAD_REQUEST, "E5002", "조원을 찾을 수 없습니다"),
    ...
    DEPARTMENT_NOT_FOUND(HttpStatus.BAD_REQUEST, "E5005", "찾을 수 없는 부서입니다"),
    VILLAGE_NOT_FOUND(HttpStatus.BAD_REQUEST, "E5006", "마을을 찾을 수 없습니다"),
    VILLAGE_LEADER_NOT_FOUND(HttpStatus.BAD_REQUEST, "E5007", "마을장을 찾을 수 없습니다"),
    VILLAGE_NOT_IN_DEPARTMENT(HttpStatus.BAD_REQUEST, "E5008", "마을이 해당 부서에 속하지 않습니다"),
    
    // 시스템/배치 관련 (E9000-E9099)
    BATCH_JOB_NOT_FOUND(HttpStatus.BAD_REQUEST, "E9000", "배치 작업을 찾을 수 없습니다"),
    ...
    SYSTEM_SETTING_NOT_FOUND(HttpStatus.BAD_REQUEST, "E9003", "시스템 설정을 찾을 수 없습니다"),
