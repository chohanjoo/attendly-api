...
enum class ErrorMessage(
    ...
    DELEGATEE_NOT_FOUND(HttpStatus.NOT_FOUND, "E1002", "수임자를 찾을 수 없습니다"),
    GBS_GROUP_NOT_FOUND(HttpStatus.NOT_FOUND, "E404", "GBS 그룹을 찾을 수 없습니다"),
    INVALID_DELEGATION_DATES(HttpStatus.BAD_REQUEST, "E1000", "시작일은 종료일보다 이전이거나 같아야 합니다"),
    INVALID_START_DATE(HttpStatus.BAD_REQUEST, "E1000", "시작일은 현재 날짜 이후여야 합니다"),
    DUPLICATE_DELEGATION(HttpStatus.CONFLICT, "E1001", "이 GBS 그룹에 이미 활성 위임이 존재합니다"),
    
    // GBS 관련 메시지
    NO_CURRENT_GBS_FOR_LEADER(HttpStatus.NOT_FOUND, "E404", "현재 담당하는 GBS가 없습니다"),
    LEADER_NOT_FOUND(HttpStatus.NOT_FOUND, "E1002", "해당 리더를 찾을 수 없습니다"),
    NO_ACTIVE_LEADER(HttpStatus.NOT_FOUND, "E404", "해당 날짜에 활성화된 GBS 리더를 찾을 수 없습니다"),
    MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "E404", "조원을 찾을 수 없습니다"),
    
    // 이메일 관련 메시지
    DUPLICATE_EMAIL(HttpStatus.CONFLICT, "E1001", "이미 사용 중인 이메일입니다"),
    
    // 부서 관련 메시지
    DEPARTMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "E404", "찾을 수 없는 부서입니다"),
    
    // 마을 관련 메시지
    VILLAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "E404", "마을을 찾을 수 없습니다"),
    
    // 배치 작업 관련 메시지
    BATCH_JOB_NOT_FOUND(HttpStatus.NOT_FOUND, "E404", "배치 작업을 찾을 수 없습니다"),
    CANNOT_CANCEL_COMPLETED_JOB(HttpStatus.BAD_REQUEST, "E1000", "이미 완료되거나 실패한 작업은 취소할 수 없습니다"),
